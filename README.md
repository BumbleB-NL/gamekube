...
Next install the driver, (important, when using nodes that have both the `control-plane` and the `etcd` taint do __not__ use `--set controller.runOnControlPlane=true`.
